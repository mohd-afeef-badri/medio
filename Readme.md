...
- FreeFEM (version 4.15)
- MedCoupling (version 9.15)
- MPI
...
- medio will be installed in the  `/home/Work/tmp/medio/lib` directory. You can choose a directory that you wish to install medio.
- After successfull install, the root directories for medcoupling, medfile, and hdf5 will be automatically located in `ext/MEDCOUPLING-9.15.0-MPI/INSTALL`.
...
##### Example 4: loading a field from med file
...
loadmedfield( "medfile_with_field.med", 
              meshname = "Mesh"                  , 
              fieldname = "u"                    , 
              field = tt                         , 
              order = fieldOrder                 , 
